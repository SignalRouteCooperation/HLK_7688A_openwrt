...
/*
    ...
    ==========================================================================
*/
INT Set_CfgDebugSwitch_Proc(RTMP_ADAPTER *pAd, PSTRING *arg)
{
        ULONG dbg;
...
*/
extern 
VOID Set_CfgApcliPassword(RTMP_ADAPTER *pAd, PSTRING *arg)
{
        UCHAR i, j;
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	*wrq)
{
        ...
        pEntry = MacTableInsertEntry(pAd, MacAddr, 0, OPMODE_AP, TRUE);
        if (pEntry)
        {
