...
/* begin: add by chenzejun for mac scan by 2015.1.22 */

 #define NETLINK_24G 24
  #define NETLINK_UNIT_24G 26
...
#define JOYLINK_TLV_TYPE_MAC              1     // MAC
#define JOYLINK_TLV_TYPE_DATA             2     // rawdata
#define JOYLINK_TLV_TYPE_SSID              3     // ssid
#define JOYLINK_TLV_TYPE_PASSWD         4     // passwd
#define JOYLINK_TLV_TYPE_VENDOR         5     // vendor
#define JOYLINK_TLV_TYPE_MAX              6     // max value


#define AP_JOYLINK_TYPE_BEACON             1      // ap  <----  sta
#define AP_JOYLINK_TYPE_DATA                 2      // data
#define AP_JOYLINK_TYPE_MAC_HIT            3      // hit
#define AP_JOYLINK_TYPE_INFO_UPDATE    4     // info update
#define AP_JOYLINK_TYPE_BEACON_RAW     5      // ap  <----  sta
...
#define WTEST_TLV_TYPE_MAC              1     // MAC
#define WTEST_TLV_TYPE_DATA             2     // rawdata
#define WTEST_TLV_TYPE_SSID              3     // ssid
#define WTEST_TLV_TYPE_PASSWD         4     // passwd
#define WTEST_TLV_TYPE_VENDOR         5     // vendor
#define WTEST_TLV_TYPE_MAX              6     // max value


#define AP_WTEST_TYPE_BEACON             1      // ap  <----  sta
#define AP_WTEST_TYPE_DATA                 2      // data
#define AP_WTEST_TYPE_80211_FRAME    3     // mac frame
#define AP_WTEST_TYPE_80211_FRAME_BY_ENTRY    4     // mac frame  by mac entry send


#define CFGDEV_LOG_TX       1
#define CFGDEV_LOG_RX       2
#define CFGDEV_LOG_INFO   3
#define CFGDEV_LOG_ALL   8


extern UCHAR g_cfgdev_debug_flag;
#define CFGDEV_DBG_PRINTK(dType, args...) \
do{                                   \
        if (g_cfgdev_debug_flag >= CFGDEV_LOG_ALL || g_cfgdev_debug_flag == dType)          printk(args);  \
}while(0)

#ifndef RTMP_DESC
#define RTMP_DESC(str)        1
#endif
...
#define AP_NLMSG_PID_CRYPTOD            0x1002
#define AP_NLMSG_PID_JOYLINK             0x1003
#define AP_NLMSG_PID_WIFITEST            0x1004
#define AP_NLMSG_PID_DHCPDOG            0x1005

#define AP_NLMSG_GROUP                      3
...
/* end: add by chenzejun for mac scan by 2015.1.22 */
