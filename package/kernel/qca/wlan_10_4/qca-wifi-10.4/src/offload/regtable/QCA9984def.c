...
//#include "QCA9984/extra/hw/rtc_reg.h"
// FIXME Need to add appropriate changes in QCA9984/extra/hw/rtc_reg.h
#ifdef WLAN_HEADERS
...
#include "targetdef.h"
#include "hostdef.h"
struct targetdef_s *QCA9984_TARGETdef=NULL;
struct hostdef_s *QCA9984_HOSTdef=NULL;
