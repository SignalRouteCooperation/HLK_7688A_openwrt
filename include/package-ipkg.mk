...
ifeq ($(DUMP),)
  define BuildTarget/ipkg
    ...
    #victor @20160516 remove 7620 7628 ipk distinguishing
    #victor @20160419 add this condition to distinguish 7620 and 7628 *.ipk
    #if u want to some more platform in, please modify 'scripts/ipkg-build' too
    #ifeq ($(CONFIG_TARGET_ramips_mt7620_ZC9525),y)
    #    IPKG_$(1):=$$(PDIR_$(1))/$(1)_$(VERSION)_$(PKGARCH)_7620.ipk
    #endif
    #ifeq ($(CONFIG_TARGET_ramips_mt7620_ZC9526),y)
    #    IPKG_$(1):=$$(PDIR_$(1))/$(1)_$(VERSION)_$(PKGARCH)_7620.ipk
    #endif
    #ifeq ($(CONFIG_TARGET_ramips_mt7620_ZC9527),y)
    #    IPKG_$(1):=$$(PDIR_$(1))/$(1)_$(VERSION)_$(PKGARCH)_7620.ipk
    #endif
    #ifeq ($(CONFIG_TARGET_ramips_mt7628_ZC9525A), y)
    #    IPKG_$(1):=$$(PDIR_$(1))/$(1)_$(VERSION)_$(PKGARCH)_7628.ipk
    #endif
    #ifeq ($(CONFIG_TARGET_ramips_mt7628_ZC9526A), y)
    #    IPKG_$(1):=$$(PDIR_$(1))/$(1)_$(VERSION)_$(PKGARCH)_7628.ipk
    #endif
    #end victor
