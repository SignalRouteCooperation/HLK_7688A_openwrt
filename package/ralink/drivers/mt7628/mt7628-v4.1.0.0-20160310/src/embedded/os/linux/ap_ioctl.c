...
{ RTPRIV_IOCTL_ADD_WHITE_MAC_LIST,
  IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | 1024 ,
  "add_white_mac"},
{ RTPRIV_IOCTL_DEL_WHITE_MAC_LIST,
  IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | 1024 ,
  "del_white_mac"},
{ RTPRIV_IOCTL_GET_WHITE_MAC_LIST,
  IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | 1024 ,
  "get_white_mac"},
  #endif
...
{ RTPRIV_IOCTL_GET_VERIFY_RESULT,
  IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | 1024,
  "get_apcli_verify"},
...
/* end of modification */
		...
		case RTPRIV_IOCTL_STATISTICS:
			...
			break;
/* begin: add by chenzejun for mac del by 2016.1.30 */
		case RTPRIV_IOCTL_DEL_MAC_TABLE_LIST:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_DEL_MAC_TABLE_LIST, 0, NULL, 0);
		             break;
/* end: add by chenzejun for mac del by 2016.1.30 */
		case RTPRIV_IOCTL_ADD_MAC_TABLE_LIST:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_ADD_MAC_TABLE_LIST, 0, NULL, 0);
		             break;
/* end: add by chenzejun for mac add by 2016.2.30 */
/* begin: add by chenzejun for mac filter by 2016.1.30 */
		case RTPRIV_IOCTL_ADD_WHITE_MAC_LIST:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_AP_ADD_WHITE_MAC, 0, NULL, 0);
		             break;
		case RTPRIV_IOCTL_DEL_WHITE_MAC_LIST:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_AP_DEL_WHITE_MAC, 0, NULL, 0);
		             break;
		case RTPRIV_IOCTL_GET_WHITE_MAC_LIST:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_AP_GET_WHITE_MAC, 0, NULL, 0);
		             break;
/* end: add by chenzejun for mac filter by 2016.1.30 */
/* begin: add by chenzejun for apcli verify by 2017.1.30 */
		case RTPRIV_IOCTL_GET_VERIFY_RESULT:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GET_APCLI_VERIFY_RESULT, 0, NULL, 0);
		             break;
/* end: add by chenzejun for apcli verify by 2017.1.30 */
