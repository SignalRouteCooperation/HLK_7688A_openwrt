...
#endif
/* ATH_BAND_STEERING_NOT_DEFINED is temporary workaround 
   till QSDK define relevant flags , it must be removed for proper 
   functioning of band stereing 
*/
#define ATH_BAND_STEERING_NOT_DEFINED 0
/*
...
#if ATH_BAND_STEERING_NOT_DEFINED
static void
...
#undef ATH_BAND_STEERING_NOT_DEFINED
