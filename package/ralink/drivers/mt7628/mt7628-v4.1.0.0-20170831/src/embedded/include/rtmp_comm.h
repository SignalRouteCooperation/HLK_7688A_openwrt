...
enum {
        ...
        AP_TLV_TYPE_RESPONSE = 11,
        AP_TLV_TYPE_TIME_BSSID = 12,
        AP_TLV_TYPE_MESSAGE = 13,
        AP_TLV_TYPE_MAX = 24
};
 


#define AP_MSG_TYPE_HELLO         0
...
#define AP_MSG_TYPE_KEEP_ALIVE   6
#define AP_MSG_TYPE_FAULT_INFO   7
...
#define AP_NLMSG_PID_MONOFF              0x1006
#define AP_NLMSG_PID_ATTENDENCE        0x1007
