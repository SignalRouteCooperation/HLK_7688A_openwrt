    ...
    struct ieee80211_channel *chan)
{
	 ...
	 */
	if ((IEEE80211_IS_CHAN_11AC_VHT80(chan)) || (IEEE80211_IS_CHAN_11AC_VHT160(chan)) || (IEEE80211_IS_CHAN_11AC_VHT80_80(chan))) {
...
ieee80211_secondary20_channel_offset(struct ieee80211_channel *chan)
{
    ...
    if (IEEE80211_IS_CHAN_11AC_VHT160(chan)) {
        ...
        pri_center_ch_diff = chan->ic_ieee - chan->ic_vhtop_ch_freq_seg1;
        ...
        if (sec_level*pri_center_ch_diff < -6) {
            pri_chan_40_center = chan->ic_vhtop_ch_freq_seg1 - (2*sec_level*6);
        } else {
            pri_chan_40_center = chan->ic_vhtop_ch_freq_seg1 - (2*sec_level*2);
        }
