    ...
    IN  UCHAR strLen)
{
    ...
    /* begin: add by chenzejun for apcli support utf-8 by 2017.1.22 */
    return TRUE;    //modify by chenzejun for apcli  scan support utf-8
    /* end: add by chenzejun for apcli support utf-8 by 2017.1.22 */
