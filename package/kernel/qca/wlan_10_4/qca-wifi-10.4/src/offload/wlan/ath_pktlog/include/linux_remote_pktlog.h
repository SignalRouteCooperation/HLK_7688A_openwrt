...
struct pktlog_remote_service {
    adf_os_work_t   connection_service; /* WORKQ for connection service */
    adf_os_work_t   accept_service;  /* WORKQ for accept service */
    adf_os_work_t   send_service;    /* WORKQ for data send serivce */
