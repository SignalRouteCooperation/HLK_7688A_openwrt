...
#define CE_SRC_RING_SZ_MAX  0xFFFF
#define CE_DEST_RING_SZ_MAX 0xFFFF
...
#define CE_SRC_RING_SZ_SET(targid, CE_ctrl_addr, n) \
        A_TARGET_WRITE((targid), (CE_ctrl_addr)+SR_SIZE_ADDRESS, ((n) & CE_SRC_RING_SZ_MAX))
...
#define CE_DEST_RING_SZ_SET(targid, CE_ctrl_addr, n) \
        A_TARGET_WRITE((targid), (CE_ctrl_addr)+DR_SIZE_ADDRESS, ((n) & CE_DEST_RING_SZ_MAX))
...
#define CE_HTT_TX_LOCK(x)  adf_os_spin_lock_bh(x)
#define CE_HTT_TX_UNLOCK(x)  adf_os_spin_unlock_bh(x)
#else
#define CE_HTT_TX_LOCK(x)
#define CE_HTT_TX_UNLOCK(x)
#endif
