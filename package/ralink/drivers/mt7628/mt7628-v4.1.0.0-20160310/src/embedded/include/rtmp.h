...
typedef struct _MAC_TABLE_ENTRY {
	...
	*/
	...
	ULONG cli_cap_flags;
        ...
        /* begin: add by chenzejun for mac filter by 2016.1.30 */
             INT32 mac_white_flag;
             INT32 mac_black_flag;
     	UCHAR mac_PMK[64];
        /* end: add by chenzejun for mac filter by 2016.1.30 */


         /* begin: add by chenzejun for apcli verify by 2017.1.30 */
             INT32 VerifyTimeOutCount;
...
typedef struct _REPEATER_ADAPTER_DATA_TABLE {
 ...
 /* begin: add by chenzejun for apcli verify by 2017.1.30 */
 #define  APCLI_PSK_COUNT   6
 typedef struct APCLI_PASSWORD_VERIFY {
	UCHAR Password[64+8];		/* password */
	UCHAR PMK[32];		/* WPA PSK mode PMK,  */
	UCHAR bVerifyResult;		/* 1 is true, 0 is false */
}APCLI_PASSWORD_VERIFY;
 /* end: add by chenzejun for apcli verify by 2017.1.30 */
...
typedef struct _APCLI_STRUCT {
 ...
 /* begin: add by chenzejun for apcli verify by 2017.1.30 */
	struct APCLI_PASSWORD_VERIFY  stApcliVerify[APCLI_PSK_COUNT];   /* password */
	UCHAR bApCliVerifyEnable;	/* 1 is true, 0 is false */
	UCHAR PMKCurrentId;		/* 1 is true, 0 is false */
	UCHAR PMKNextId;		/* 1 is true, 0 is false */
 /* end: add by chenzejun for apcli verify by 2017.1.30 */
