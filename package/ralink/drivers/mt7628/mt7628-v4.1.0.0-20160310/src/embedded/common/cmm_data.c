...
/* begin: add by chenzejun for joylink by 2016.4.20 */
#ifdef JOYLINK_SUPPORT
                        if (pAd->debug_flag ==  1)      retryCnt = 1;
#endif
/* end: add by chenzejun for joylink by 2016.4.20 */
			...
			case SUBTYPE_DATA_NULL:
                ...
                transmit = &pAd->CommonCfg.MlmeTransmit;
                                       /* begin: add by chenzejun for joylink config by 2016.4.20 */
                                                ...
                                                if (pAd->debug_flag)
                                                {
                                                        //UCHAR *P = (UCHAR *)pHeader_802_11;
                                                        pHeader_802_11->FC.SubType = SUBTYPE_DATA;
                                                        //P[0] = 0x8;
                                                        //P[1] = 0x9;
                                                        //P[3] = 0x0;
                                                        //pHeader_802_11->Sequence = 0x50;
                                                }
									   #endif
