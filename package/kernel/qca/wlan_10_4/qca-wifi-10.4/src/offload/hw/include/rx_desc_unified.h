                                                  ...
                                                  uint32_t permsdu_flag)
{
    ...
    struct per_msdu_data_recv_status rx_status;
    offset = sizeof(struct cvg_nbuf_cb);
#else
    struct per_msdu_mesh_data_recv_status rx_status;
    offset = 0;
#endif
    ...
    if (!permsdu_flag || (is_head)) {
        ...
        if (first_mpdu) {
            ...
            adf_nbuf_set_rx_info(head_msdu, (void *)&rx_status, sizeof(rx_status), offset);
        }
    ...
    if (!permsdu_flag || (is_tail)) {
        ...
        if (last_mpdu) {
            ...
            adf_nbuf_set_rx_info(tail_msdu, (void *)&rx_status, sizeof(rx_status), offset);
        }
    }
