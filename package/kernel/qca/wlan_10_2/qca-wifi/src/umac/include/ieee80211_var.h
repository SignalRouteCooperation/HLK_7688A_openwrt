...
/* begin: add by chenzejun for landi-pos-auto by 2017.1.30 */   
    u_int32_t                  auto_link_enable;
    ieee80211_ssid        auto_link_ssid;/* desired ssid list */
...
#define AP_TLV_TYPE_MAC         1
#define AP_TLV_TYPE_RSSI      2
#define AP_TLV_TYPE_STA_STAUS        3
#define AP_TLV_TYPE_TIME        4
#define AP_TLV_TYPE_CHANNEL        5
#define AP_TLV_TYPE_WIFI_TYPE        6
#define AP_TLV_TYPE_TX_POWER        7
#define AP_TLV_TYPE_CONN_TYPE        8
#define AP_TLV_TYPE_IP        9
#define AP_TLV_TYPE_CONN_COUNT   10
#define AP_TLV_TYPE_MAX        24
...
#define CRYPTO_TLV_TYPE_ECC_NID              1     // eclipse curve parameter value,  onto the nid of openssl
#define CRYPTO_TLV_TYPE_PUBLIC_KEY         2     // public key
#define CRYPTO_TLV_TYPE_SHARE_KEY          3     // share key,   compute by public key
#define CRYPTO_TLV_TYPE_MAX                     4     // max value

#define AP_NLMSG_TYPE_GET               1
#define AP_NLMSG_TYPE_RESULT          2
...
{
	u_int16_t us_tlv_type;
	u_int16_t us_tlv_len;
}AP_TLV_DATA;
