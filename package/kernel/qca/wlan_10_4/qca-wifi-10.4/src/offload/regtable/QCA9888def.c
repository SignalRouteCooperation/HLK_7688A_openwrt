...
//#include "QCA9888/extra/hw/rtc_reg.h"
// FIXME Need to add appropriate changes in QCA9888/extra/hw/rtc_reg.h
#ifdef WLAN_HEADERS
...
#include "targetdef.h"
#include "hostdef.h"
struct targetdef_s *QCA9888_TARGETdef=NULL;
struct hostdef_s *QCA9888_HOSTdef=NULL;
