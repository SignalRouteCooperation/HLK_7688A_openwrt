...
extern DEVICEDLLSPEC int DeviceOtpProgram(unsigned char *filename, int dummy, int verbose);

extern DEVICEDLLSPEC int DeviceOtpDump();
...
extern DEVICEDLLSPEC int DeviceFlashBlockWrite(unsigned int address, unsigned int size, char* fileName);
...
extern DEVICEDLLSPEC int DeviceIniFileFieldWrite(unsigned int address, int low, int high, unsigned int value);

extern DEVICEDLLSPEC int DeviceIniFileFieldClear(unsigned int address, int low, int high);
...
extern DEVICEDLLSPEC int DeviceLplGet();
...
extern DEVICEDLLSPEC int DevicetlvCalibrationInit(int mode);
extern DEVICEDLLSPEC int DevicetlvCalibrationStart(void);
extern DEVICEDLLSPEC int DevicetlvCalibration(double pwr);
extern DEVICEDLLSPEC int DeviceGpioConfig(int pin, int iomode, int driverStrength, int pullMode, int configMode);
//
...
//#endif
    ...
    int (*OtpProgram)(char * filename, int dummy, int verbose);
    int (*OtpDump)();
    
    int (*FlashBlockWrite)(unsigned int address, unsigned int size, const char* fileName);
	int (*FlashBlockRead)(unsigned int address, unsigned int size, const char* fileName);
	int (*LplGet)(); /* LPL : Low Power Listen. It is for Rx. */
	int (*GpioConfig)(int pin, int iomode, int driverStrength, int pullMode, int configMode);
    int (*IniFileFieldWrite)(unsigned int address, int low, int high, unsigned int value);
    int (*IniFileFieldClear)(unsigned int address, int low, int high);
    int (*RxIqCalibration)();
    int (*BandwidthSet)(int bandwidth);
};
