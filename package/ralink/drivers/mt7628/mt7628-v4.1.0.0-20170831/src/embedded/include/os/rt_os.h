...
#define RTPRIV_IOCTL_DEL_MAC_TABLE_LIST                     (SIOCIWFIRSTPRIV + 0x18)
/* end: add by chenzejun for mac del by 2016.1.30 */
/* begin: add by chenzejun for mac add by 2016.2.30 */
#define RTPRIV_IOCTL_ADD_MAC_TABLE_LIST                     (SIOCIWFIRSTPRIV + 0x1B)
/* end: add by chenzejun for mac add by 2016.2.30 */
/* begin: add by chenzejun for mac add by 2016.2.30 */
#define RTPRIV_IOCTL_ADD_WHITE_MAC_LIST                     (SIOCIWFIRSTPRIV + 0x1C)
#define RTPRIV_IOCTL_DEL_WHITE_MAC_LIST                     (SIOCIWFIRSTPRIV + 0x1E)
#define RTPRIV_IOCTL_GET_WHITE_MAC_LIST                     (SIOCIWFIRSTPRIV + 0x17)   //0x1F and 0x17 0x1d and 0x0f and 0x07 0x0d is ok
/* end: add by chenzejun for mac add by 2016.2.30 */

/* begin: add by chenzejun for mac add by 2016.2.30 */
//#define RTPRIV_IOCTL_SET_APCLI_PASSWORD                    (SIOCIWFIRSTPRIV + 0x1E)
#define RTPRIV_IOCTL_GET_VERIFY_RESULT                    (SIOCIWFIRSTPRIV + 0x1D)
/* end: add by chenzejun for mac add by 2016.2.30 */
