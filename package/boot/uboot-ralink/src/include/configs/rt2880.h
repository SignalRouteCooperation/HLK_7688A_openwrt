...
#define CONFIG_BOOTCOMMAND	"bootm 0xbc050000" //"run flash_self"
#define CONFIG_BOOTFILE "recovery.bin"
...
#define RT2880_REG_PIODATA_RST      (RT2880_PRGIO_ADDR + 0x24)
...
#define RT2880_REG_PIODATA      (RT2880_PRGIO_ADDR + 0x20)
/* begin: add by chenzejun for tftp by reset key by 2016.1.22 */
#define RT2880_REG_PIODATA_RST    (RT2880_PRGIO_ADDR + 0x20)
/* end: add by chenzejun for tftp by reset key by 2016.1.22 */
