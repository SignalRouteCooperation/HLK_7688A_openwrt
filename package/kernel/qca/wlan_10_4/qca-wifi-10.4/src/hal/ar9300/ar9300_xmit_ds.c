...
ar9300_calc_ptr_chk_sum(struct ar9300_txc *ads)
{
    ...
    /* checksum = __bsxwap32(ads->ds_info) + ads->ds_link */
    ...
    const void *ds0)
{
    ...
    if (first_seg) {
        ...
        ads->ds_ctl13 = __bsxwap32(AR9300TXC_CONST(ds0)->ds_ctl13);
        ads->ds_ctl14 = __bsxwap32(AR9300TXC_CONST(ds0)->ds_ctl14);
        ads->ds_ctl17 = __bsxwap32(SM(key_type, AR_encr_type));
#else
...
ar9300_swap_tx_desc(void *dsp)
{
    ...
    ds->ds_info = __bsxwap32(ds->ds_info);
    ds->status1 = __bsxwap32(ds->status1);
    ds->status2 = __bsxwap32(ds->status2);
    ds->status3 = __bsxwap32(ds->status3);
    ds->status4 = __bsxwap32(ds->status4);
    ds->status5 = __bsxwap32(ds->status5);
    ds->status6 = __bsxwap32(ds->status6);
    ds->status7 = __bsxwap32(ds->status7);
    ds->status8 = __bsxwap32(ds->status8);
}
#endif
...
#endif
#ifdef AH_NEED_DESC_SWAP
    last_ads->ds_ctl13 = __bsxwap32(ads->ds_ctl13);
    last_ads->ds_ctl14 = __bsxwap32(ads->ds_ctl14);
#else
