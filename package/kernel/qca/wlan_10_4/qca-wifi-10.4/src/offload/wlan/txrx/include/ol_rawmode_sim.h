...
do {                                                                         \
    ...
    adf_nbuf_t nbuf = (_subhead);                                            \
                                                                             \
    if ((_head) == (_subhead)) {                                             \
        (_head) = adf_nbuf_next((_subtail));                                 \
    }                                                                        \
                                                                             \
    if (!(_head)) {                                                          \
        (_tail) = NULL;                                                      \
        ...
        (_tail) = (_prev);                                                   \
        adf_nbuf_set_next((_tail), NULL);                                    \
    } else if ((_prev)) {                                                    \
        adf_nbuf_set_next((_prev), adf_nbuf_next((_subtail)));               \
    }                                                                        \
                                                                             \
    while(nbuf != (_subtail))                                                \
    {                                                                        \
...
do {                                                                         \
    ...
    if (!(_head)) {                                                          \
        ...
        adf_nbuf_set_next((_prev), adf_nbuf_next((_nbuf)));                  \
    }                                                                        \
                                                                             \
    adf_nbuf_free((_nbuf));                                                  \
} while (0)
